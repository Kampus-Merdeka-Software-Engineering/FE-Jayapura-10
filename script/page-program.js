...
function dataForm(e){
    ...
    fetch('https://be-jayapura-10-a6pk-muhammadfijas-projects.vercel.app/daftar',{
        method: 'POST',
        headers: {
...
function getContentData(){
    fetch('https://be-jayapura-10-a6pk-muhammadfijas-projects.vercel.app/programcontent')
